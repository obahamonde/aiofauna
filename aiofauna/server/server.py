...
class APIServer(Application):
    ...
    def __init__(
        ...
        *args: Any,
        ...
        description: str = "AioFauna REST API",
        version: str = "0.0.1",
    ...
    def document(
        ...
        def decorator(func: Callable[P, Awaitable[_T]]) -> Callable[P, Awaitable[_T]]:
            sig = signature(func)
            ...
            async def wrapper(*args: P.args, **kwargs: P.kwargs) -> StreamResponse:
                ...
                if asyncio.iscoroutinefunction(func):
                    response = await func(*new_args, **kwargs, **definitive_args)
                else:
